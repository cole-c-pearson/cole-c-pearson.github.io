    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "resources-how-this-section-works",
          ...
          section: "Resources",handler: () => {
              window.location.href = "/resources/start-here/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/cole-pearson-CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/cole-pearson-chemistry", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0002-9286-5062", "_blank");
        },
      },];
